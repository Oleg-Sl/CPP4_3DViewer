...
TEST(MoveObject, PositiveMoveX) {
    Scene scene;
    scene.SetVertices({1.1, 11.0, 21.0, 34.1, 5.555, -54, 1000001.1, 0.924, 765.0});
...
TEST(MoveObject, NegativeMoveX) {
    Scene scene;
    scene.SetVertices({-4.3, 11.0, 21.0, 28.7, 5.555, -54, 999995.7, 0.924, 765.0});
...
TEST(MoveObject, PositiveMoveZ) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 32.15, 32, 5.555, -42.85, 999999, 0.924, 776.15});
    scene.TransformVertices(TransformMatrixBuilder::CreateMoveMatrix(0, 0, 11.15));
    ASSERT_FLOAT_EQ(scene.GetVertices()[0], -1.0);
    ASSERT_FLOAT_EQ(scene.GetVertices()[1], 11.0);
...
TEST(MoveObject, MoveXYZ) {
    Scene scene;
    scene.SetVertices({-6.2, 12.2, 26.6, 26.8, 6.755, -48.4, 999993.8, 2.124, 770.6});
    scene.TransformVertices(TransformMatrixBuilder::CreateMoveMatrix(-5.2, 1.2, 5.6));
...
TEST(RotateObject, ClockwiseRotateX) {
    ...
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(1.15, 0, 0));
...
TEST(RotateObject, CounterclockwiseRotateX) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(-1, 0, 0));
    ASSERT_FLOAT_EQ(scene.GetVertices()[0], -1);
...
TEST(RotateObject, ClockwiseRotateY) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(0, 1.5, 0));
...
TEST(RotateObject, CounterclockwiseRotateY) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(0, -0.77, 0));
...
TEST(RotateObject, ClockwiseRotateZ) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(0, 0, 0.5));
...
TEST(RotateObject, CounterclockwiseRotateZ) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(0, 0, -1.7));
...
TEST(RotateObject, RotateXYZ) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateRotationMatrix(0.245, 0.245, 0.245));
...
TEST(ScaleObject, DecScaleZ) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateScaleMatrix(1, 1, 0.35));
    ASSERT_FLOAT_EQ(scene.GetVertices()[0], -1.0);
    ASSERT_FLOAT_EQ(scene.GetVertices()[1], 11.0);
...
TEST(ScaleObject, ScaleXYZ) {
    Scene scene;
    scene.SetVertices({-1.0, 11.0, 21.0, 32.0, 5.5550, -54, 999999, 0.924, 765});
    scene.TransformVertices(TransformMatrixBuilder::CreateScaleMatrix(3.3, 3.3, 3.3));
